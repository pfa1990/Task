...
while True:
    surface.fill((0, 0, 0))
    # Code Block 1
    pygame.draw.rect(surface, (255, 255, 0), (rectX-rectWidth /2,
                     rectY-rectHeight /2, rectWidth, rectHeight))
    rectWidth += 1
    rectHeight += 1

    # Code Block 2
    """
    pygame.draw.rect(surface, (squaresRed, squaresGreen, squaresBlue), (50, 50,
