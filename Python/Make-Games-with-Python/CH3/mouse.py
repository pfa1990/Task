...
def checkBounds():
    ...
    if mousePressed == True:
        ...
        if (mousePosition[0] > squareX and mousePosition[0] < squareX +
            squareSize):
            if (mousePosition[1] > squareY and mousePosition[1] < squareY +
                squareSize):
                draggingSquare = True
...
def drawSquare():
    ...
    pygame.draw.rect(surface, squareColor, (squareX, squareY, squareSize,
                     squareSize))
