...
def move():
    ...
    # Move left
    if leftDown:
        # If we're already moving to the right, reset the moving speed and
    ...
    if (playerVX > 0.0 and playerVX < maxSpeed) or (playerVX < 0.0 and
        playerVX > -maxSpeed):
...
while True:
    ...
    pygame.draw.rect(surface, (255, 0, 0), (playerX, playerY, playerSize,
                     playerSize))
